  ...
  public void run() {
    while(true) {
      if(restaurant.order == null) {
        ...
        /**
         * Since only one thread is waiting on WaitPerson's lock,
         * notify() and notifyAll() produce same result.
         * notifyAll() notifies all the threads that are waiting on
         * waitPerson object's monitor(lock).
         * Currently only waitPerson is waiting on itself.
         */
