...
public class MapPerformance {
  ...
  public static void main(String[] args) {
	...
	test(new SimpleHashMap(), 10);
	test(new SimpleHashMapAL(), 10);
    // Medium:
   ...
   // test(new WeakHashMap(), 100);
	...
	test(new SimpleHashMap(), 100);
	test(new SimpleHashMapAL(), 100);
	...
	test(new SimpleHashMap(), 1000);
	test(new SimpleHashMapAL(), 1000);
  }
} ///:~
