...
public class MapPerformance {
  ...
  public static void main(String[] args) {
	...
	test(new SlowMap(), 100);
	test(new SlowMapSortedV2(), 100);
    // Large:
   // test(new TreeMap(), 1000);
	...
	test(new SlowMap(), 1000);
	test(new SlowMapSortedV2(), 1000);
  }
} ///:~
