...
public class CountedString {
  ...
  public int hashCode() {
	...
	/* With this approach, the hashCode is resulting in an
	uneven distribution of values. If the values tend to cluster,
	the, HashMap or HashSet will not be as fast as it can be with
