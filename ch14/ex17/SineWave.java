...
class SineDraw extends JPanel {
  ...
  public void setSines(double[] sns) {
    sines = sns;
  }
  public double[] getSines() {
    return sines;
  }
  public void setSine(int sineIndex, double sns) {
    sines[sineIndex] = sns;
  }
  public double getSine(int sineIndex) {
    return sines[sineIndex];
  }
  public void setPts(int[] pnts) {
    pts = pnts;
  }
  public int[] getPts() {
    return pts;
  }
  public void setPt(int ptsIndex, int point) {
    pts[ptsIndex] = point;
  }
  public int getPt(int ptsIndex) {
    return pts[ptsIndex];
  }
